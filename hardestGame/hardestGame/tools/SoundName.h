...
#define kBgMusicFileName @"bg_music.mp3"
#define kSoundClickButtonFileName @"click.mp3"
#define kSoundChainDropFileName @"chain_drop.mp3"
#define kSoundNewPopFileName @"new_pop.mp3"
